        ...
        <div class="col-sm-9">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="form" action="{{ route('agenda.update', $agenda->id) }}" method="POST" >
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="dari" name="dari" type="text"
                                        ...
                                        value="{{ old('dari') ?? $agenda->dari }}" required>
                                    @error('dari')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="tgl_agenda" data-target-input="nearest">
                                        <input type="text" class="form-control @error('tgl_agenda') is-invalid @enderror
                                            datetimepicker-input" name="tgl_agenda" data-target="#tgl_agenda" value="{{ old('tgl_agenda') ?? $agenda->tgl_agenda }}" required/>
                                    ...
                                    <select id="skpk_id" name="skpk_id" class="form-control select2bs4 @error('skpk_id') is-invalid @enderror" style="width: 100%;" required>
                                        @foreach ($skpk as $skpk)
                                            <option {{ $loop->first ?? 'selected = selected' }}
                                                ...
                                                {{ ($skpk->id == $agenda->skpk_id) ? 'selected' : '' }}>
                                                {{ $skpk->nm_skpk }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div id="input_group_no_spm" class="input-group">
                                        <input id="no_spm" name="no_spm" type="text" class="form-control @error('no_spm') is-invalid @enderror" value="{{ old('no_spm') ?? $agenda->no_spm }}" readonly required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="tgl_spm" data-target-input="nearest">
                                        <input type="text" class="form-control @error('tgl_spm') is-invalid @enderror datetimepicker-input"
                                            name="tgl_spm" data-target="#tgl_spm" value="{{ old('tgl_spm') ?? $agenda->tgl_spm }}" readonly required/>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('uraian') is-invalid @enderror" readonly required
                                        id="uraian" name="uraian" rows="3">{{ old('uraian') ?? $agenda->uraian }}</textarea>
                                    @error('uraian')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input id="nm_penerima" name="nm_penerima" type="text"
                                        ...
                                        value="{{ old('nm_penerima') ?? $agenda->nm_penerima }}" readonly required>
                                    @error('nm_penerima')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input id="bank_penerima" name="bank_penerima" type="text"
                                        ...
                                        value="{{ old('bank_penerima') ?? $agenda->bank_penerima }}" readonly required>
                                    @error('bank_penerima')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input id="rek_penerima" name="rek_penerima" type="text"
                                        ...
                                        value="{{ old('rek_penerima') ?? $agenda->rek_penerima }}" readonly required>
                                    @error('rek_penerima')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input id="npwp" name="npwp" type="text"
                                        ...
                                        value="{{ old('npwp') ?? $agenda->npwp }}" readonly required>
                                    @error('npwp')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input id="jml_kotor" name="jml_kotor" type="text"
                                        ...
                                        value="{{ old('jml_kotor') ?? $agenda->jml_kotor }}" readonly required>
                                    @error('jml_kotor')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input id="potongan" name="potongan" type="text"
                                        ...
                                        value="{{ old('potongan') ?? $agenda->potongan }}" readonly required>
                                    @error('potongan')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input id="jml_bersih" name="jml_bersih" type="text"
                                        ...
                                        value="{{ old('jml_bersih') ?? $agenda->jml_bersih }}" readonly required>
                                    @error('jml_bersih')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input @error('jenis_spm') is-invalid @enderror" type="radio" id="customRadio1" name="jenis_spm" value="UP" {{ ($agenda->jenis_spm == 'UP') ? 'checked' : '' }}>
                                        <label for="customRadio1" class="custom-control-label">UP</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input @error('jenis_spm') is-invalid @enderror" type="radio" id="customRadio2" name="jenis_spm" value="GU" {{ ($agenda->jenis_spm == 'GU') ? 'checked' : '' }}>
                                        <label for="customRadio2" class="custom-control-label" >GU</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input @error('jenis_spm') is-invalid @enderror" type="radio" id="customRadio3" name="jenis_spm" value="TU" {{ ($agenda->jenis_spm == 'TU') ? 'checked' : '' }}>
                                        <label for="customRadio3" class="custom-control-label" >TU</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input @error('jenis_spm') is-invalid @enderror" type="radio" id="customRadio4" name="jenis_spm" value="LS.GJ" {{ ($agenda->jenis_spm == 'LS.GJ') ? 'checked' : '' }}>
                                        <label for="customRadio4" class="custom-control-label" >LS GAJI</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input @error('jenis_spm') is-invalid @enderror" type="radio" id="customRadio5" name="jenis_spm" value="LS.NON-GJ" {{ ($agenda->jenis_spm == 'LS.NON-GJ') ? 'checked' : '' }}>
                                        <label for="customRadio5" class="custom-control-label" >LS NON-GAJI</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input @error('jenis_spm') is-invalid @enderror" type="radio" id="customRadio6" name="jenis_spm" value="LS.BJ" {{ ($agenda->jenis_spm == 'LS.BJ') ? 'checked' : '' }}>
                                        <label for="customRadio6" class="custom-control-label" >LS Barang Jasa</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input @error('jenis_spm') is-invalid @enderror" type="radio" id="customRadio8" name="jenis_spm" value="LS.BJ-Perencanaan" {{ ($agenda->jenis_spm == 'LS.BJ-Perencanaan') ? 'checked' : '' }}>
                                        <label for="customRadio8" class="custom-control-label" >LS Barang Jasa - Perencanaan</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input @error('jenis_spm') is-invalid @enderror" type="radio" id="customRadio9" name="jenis_spm" value="LS.BJ-Pengawasan" {{ ($agenda->jenis_spm == 'LS.BJ-Pengawasan') ? 'checked' : '' }}>
                                        <label for="customRadio9" class="custom-control-label" >LS Barang Jasa - Pengawasan</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input @error('jenis_spm') is-invalid @enderror" type="radio" id="customRadio7" name="jenis_spm" value="LS.PPKD" {{ ($agenda->jenis_spm == 'LS.PPKD') ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input @error('sumberdana') is-invalid @enderror" type="radio" id="radioSumberDana1" name="sumberdana" value="APBK" {{ ($agenda->sumberdana == 'APBK') ? 'checked' : '' }}>
                                        <label for="radioSumberDana1" class="custom-control-label" >APBK</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input @error('sumberdana') is-invalid @enderror" type="radio" id="radioSumberDana2" name="sumberdana" value="DAK-FISIK" {{ ($agenda->sumberdana == 'DAK-FISIK') ? 'checked' : '' }}>
                                        <label for="radioSumberDana2" class="custom-control-label">DAK FISIK</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input @error('sumberdana') is-invalid @enderror" type="radio" id="radioSumberDana3" name="sumberdana" value="DAK-NON-FISIK" {{ ($agenda->sumberdana == 'DAK-NON-FISIK') ? 'checked' : '' }}>
                                        <label for="radioSumberDana3" class="custom-control-label">DAK NON FISIK</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input @error('sumberdana') is-invalid @enderror" type="radio" id="radioSumberDana4" name="sumberdana" value="OTSUS" {{ ($agenda->sumberdana == 'OTSUS') ? 'checked' : '' }}>
                                        <label for="radioSumberDana4" class="custom-control-label">OTSUS</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input @error('sumberdana') is-invalid @enderror" type="radio" id="radioSumberDana5" name="sumberdana" value="DID" {{ ($agenda->sumberdana == 'DID') ? 'checked' : '' }}>
                                        <label for="radioSumberDana5" class="custom-control-label">DID</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input @error('sumberdana') is-invalid @enderror" type="radio" id="radioSumberDana6" name="sumberdana" value="DID-TAMBAHAN" {{ ($agenda->sumberdana == 'DID-TAMBAHAN') ? 'checked' : '' }}>
                                        <label for="radioSumberDana6" class="custom-control-label">DID TAMBAHAN</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input @error('sumberdana') is-invalid @enderror" type="radio" id="radioSumberDana7" name="sumberdana" value="BANTUAN-KEUANGAN" {{ ($agenda->sumberdana == 'BANTUAN-KEUANGAN') ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="disposisi_user_id" name="disposisi_user_id" class="form-control @error('disposisi_user_id') is-invalid @enderror select2bs4 " style="width: 100%;" required>
                                        @foreach ($users as $user)
                                            <option
                                                value="{{ $user->id }}"
                                                {{ ($agenda->disposisi_user_id == $user->id) ? 'selected' : '' }}>
                                                {{ $user->name }}
                                            </option>
                                        @endforeach
                                    </select>
